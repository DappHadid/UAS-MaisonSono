...
@section('content')
    ...
    <h2 class="text-3xl font-bold mb-4 p-4">Manage Products 📦</h2>

    @can('manage_products')
        <div class="mb-4 lg:px-4">
            <a href="{{ route('admin.manage-products.create') }}"
                class="lg:px-4 inline-flex items-center px-5 py-2 bg-[#3f4f44] hover:bg-green-700 text-white font-medium rounded-full shadow">
    ...
    <div class="max-w-full mx-auto lg:px-4">
        <div class="bg-white shadow-lg rounded-xl p-6">
            ...
            @if (session('success'))
                <div
                    class="bg-green-100 border border-green-300 text-green-800 px-4 py-3 rounded mb-6 flex justify-between items-center">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-left">{{ $product->size }}</td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center space-x-2">
                                        ...
                                        @can('manage_products')
                                            ...
                                            <form action="{{ route('admin.manage-products.destroy', $product) }}"
                                                method="POST"
