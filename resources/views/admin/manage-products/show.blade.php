        ...
        <div class="bg-white rounded-xl shadow-xl overflow-hidden">
            <div class="md:flex">
                ...
                <div class="md:w-1/2 bg-gray-50 p-6 flex justify-center items-center">
                    ...
                    @else
                        <div
                            class="max-h-96 w-full object-contain rounded-lg bg-gray-200 flex items-center justify-center text-gray-400">
                    ...
                    <div class="border-t border-gray-200 pt-4">
                        <dl class="space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <dd
                                    class="text-sm {{ $product->diskon > 0 ? 'text-red-600 font-semibold' : 'text-gray-900' }}">
                                    {{ $product->diskon ?? 0 }}%</dd>
                            </div>
