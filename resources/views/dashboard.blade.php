    ...
    <div>
        ...
        <section id="about" class="py-5">
            <div class="container text-center">
                <h2>About Us</h2>
                <p>Kecap ABC adalah kecap manis yang terbuat dari bahan-bahan pilihan berkualitas tinggi. Dengan rasa
                    yang
        ...
        <section id="contact" class="bg-light py-5">
            <div class="container text-center">
                ...
                <form class="mt-4" method="post" action="{{ route('product.create') }}"
                ...
                <div class="row mt-4">
                    @foreach ($produk as $produk)
                        <div class="col-md-4">
                            <div class="card">
                                @if ($produk->photo)
                                    <img src="{{ asset('storage/' . $produk->photo) }}" alt="Product Image"
